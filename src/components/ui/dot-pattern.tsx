 ...
 *
 * https://www.shadcn.io/background/dot-pattern
 */
...
export function DotPattern({ className, children, dotSize = 2, gap = 24, baseColor = "#404040", glowColor = "#22d3ee", proximity = 120, glowIntensity = 1, waveSpeed = 0.5 }: DotPatternProps) {
