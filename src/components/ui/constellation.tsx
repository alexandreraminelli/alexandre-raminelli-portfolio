...
// https://www.shadcn.io/background/constellation
...
/**
 * React Constellation Background
 *
 * https://www.shadcn.io/background/constellation
 */
export function ConstellationBackground({ className, children, count = 80, connectionDistance = 150, nodeColor = "rgba(136, 196, 255, 1)", lineColor = "rgba(136, 196, 255, 0.15)", nodeSize = 2, mouseRadius = 100, glow = true }: ConstellationBackgroundProps) {
